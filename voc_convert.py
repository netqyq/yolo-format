...
flags.DEFINE_string('image_dir', '/Users/yq/Downloads/datasets/trainval/VOC2007/JPEGImages', 'path to image dir')
flags.DEFINE_string(
    'anno_dir', '/Users/yq/Downloads/datasets/trainval/VOC2007/Annotations', 'path to anno dir')
flags.DEFINE_string(
    'train_list_txt', '/Users/yq/Downloads/datasets/trainval/VOC2007/ImageSets/Main/trainval.txt', 'path to a set of train')
flags.DEFINE_string(
    'val_list_txt', '/Users/yq/Downloads/datasets/trainval/VOC2007/ImageSets/Main/val.txt', 'path to a set of val')
flags.DEFINE_string('classes', '/Users/yq/Downloads/datasets/trainval/train_classes.txt',
                    'path to a list of class names')
flags.DEFINE_string(
    'train_output', '/Users/yq/Downloads/datasets/trainval/VOC2007/ImageSets/Main/train-out.txt', 'path to a file for train')
flags.DEFINE_string(
    'val_output', '/Users/yq/Downloads/datasets/trainval/VOC2007/ImageSets/Main/val-out.txt', 'path to a file for val')

flags.DEFINE_boolean('no_val', True, 'if uses this flag, it does not convert a list of val')
